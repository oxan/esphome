...
class AddressableLightEffect : public LightEffect {
 public:
  ...
  void start_internal() override {
    for(auto view : this->get_pixels_())
...
class AddressableFlickerEffect : public AddressableLightEffect {
 public:
  ...
  void set_update_interval(uint32_t update_interval) { this->update_interval_ = update_interval; }
  void set_intensity(float intensity) { this->intensity_ = to_uint8(intensity); }
