...
class ESPColorCorrection {
 public:
  ...
  inline Color correct(Color color, uint8_t brightness) const {
  ...
  inline uint8_t correct_red(uint8_t red, uint8_t brightness) const {
    uint8_t res = esp_scale8(esp_scale8(red, this->max_brightness_.red), brightness);
    return this->gamma_table_[res];
  }
  inline uint8_t correct_green(uint8_t green, uint8_t brightness) const {
    uint8_t res = esp_scale8(esp_scale8(green, this->max_brightness_.green), brightness);
    return this->gamma_table_[res];
  }
  inline uint8_t correct_blue(uint8_t blue, uint8_t brightness) const {
    uint8_t res = esp_scale8(esp_scale8(blue, this->max_brightness_.blue), brightness);
    return this->gamma_table_[res];
  }
  inline uint8_t correct_white(uint8_t white, uint8_t brightness) const {
    uint8_t res = esp_scale8(esp_scale8(white, this->max_brightness_.white), brightness);
    return this->gamma_table_[res];
  }
  inline Color uncorrect(Color color, uint8_t brightness) const {
  ...
  inline uint8_t uncorrect_red(uint8_t red, uint8_t brightness) const {
  ...
  inline uint8_t uncorrect_green(uint8_t green, uint8_t brightness) const {
  ...
  inline uint8_t uncorrect_blue(uint8_t blue, uint8_t brightness) const {
  ...
  inline uint8_t uncorrect_white(uint8_t white, uint8_t brightness) const {
    if (this->max_brightness_.white == 0 || brightness == 0)
      return 0;
    uint16_t uncorrected = this->gamma_reverse_table_[white] * 255UL;
    uint8_t res = ((uncorrected / this->max_brightness_.white) * 255UL) / brightness;
    return res;
  }
