...
class ESPColorView : public ESPColorSettable {
 public:
  ESPColorView(AddressableLightValues& parent, int32_t index, const ESPColorCorrection *color_correction)
  ...
  void set_red(uint8_t red) override { this->parent_.set_red(this->index_, this->color_correction_->color_correct_red(red)); }
  void set_green(uint8_t green) override { this->parent_.set_green(this->index_, this->color_correction_->color_correct_green(green)); }
  void set_blue(uint8_t blue) override { this->parent_.set_blue(this->index_, this->color_correction_->color_correct_blue(blue)); }
  void set_white(uint8_t white) override { this->parent_.set_white(this->index_, this->color_correction_->color_correct_white(white)); }
  ...
  uint8_t get_red() const { return this->color_correction_->color_uncorrect_red(this->parent_.get_red(this->index_)); }
  uint8_t get_red_raw() const { return this->parent_.get_red(this->index_); }
  uint8_t get_green() const { return this->color_correction_->color_uncorrect_green(this->parent_.get_green(this->index_)); }
  uint8_t get_green_raw() const { return this->parent_.get_green(this->index_); }
  uint8_t get_blue() const { return this->color_correction_->color_uncorrect_blue(this->parent_.get_blue(this->index_)); }
  uint8_t get_blue_raw() const { return this->parent_.get_blue(this->index_); }
  uint8_t get_white() const { return this->color_correction_->color_uncorrect_white(this->parent_.get_white(this->index_)); }
